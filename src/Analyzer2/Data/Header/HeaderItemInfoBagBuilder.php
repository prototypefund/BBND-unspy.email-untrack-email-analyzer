...
final class HeaderItemInfoBagBuilder {
  ...
  /**
   * @param \SplObjectStorage<\Geeks4change\UntrackEmailAnalyzer\Analyzer2\Data\Header\HeaderItem, \Geeks4change\UntrackEmailAnalyzer\Analyzer2\Data\Header\HeaderItemInfoBuilder> $infos
   */
