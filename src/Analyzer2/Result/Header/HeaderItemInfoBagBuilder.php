...
final class HeaderItemInfoBagBuilder {
  ...
  /**
   * @param \SplObjectStorage<\Geeks4change\UntrackEmailAnalyzer\Analyzer2\Result\Header\HeaderItem, \Geeks4change\UntrackEmailAnalyzer\Analyzer2\Result\Header\HeaderItemInfoBuilder> $infos
   */
