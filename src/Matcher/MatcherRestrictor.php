...
final class MatcherRestrictor {
  ...
  public static function restrictToMatcher(string $id, FullResultWrapper $wrapper): FullResultWrapper {
            ...
            array_map(
              fn(HeaderItemInfo $info) => new HeaderItemInfo(
                ...
                array_values(array_filter(
                  $info->matches,
                  fn(HeaderItemMatch $match) => $match->matcherId === $id,
                )),
              ),
          ...
          new UrlItemInfoBag(
            array_map(
              fn(UrlItemInfo $info) => new UrlItemInfo(
                ...
                array_filter(
                  $info->matches,
                  fn(ProviderMatch $match) => $match->providerId === $id,
                ),
              ),
